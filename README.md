...
<ul>
  ...
  <li>L'utilisation de <code>DBSCAN</code>[^tesr], qui permet de faire du clustering sur les données, afin de rassembler les produits avec une description similaire</li>
