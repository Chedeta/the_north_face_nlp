...
<ul>
  ...
  <li>L'utilisation de <code>DBSCAN</code>, qui permet de[^1] faire du clustering sur les données, afin de rassembler les produits avec une description similaire</li>
